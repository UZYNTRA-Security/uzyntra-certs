...
credentials: {
Row: { id: string; credential_id: string; owner_id: string; issuer_id: string | null; credential_type: CredentialType; category: CredentialCategory; title: string; description: string | null; issue_date: string; expiry_date: string | null; status: CredentialStatus; issued_at: string | null; revoked_at: string | null; revocation_reason: string | null; certificate_file_url: string | null; verification_hash: string; public_visible: boolean; public_holder_name: string | null; created_at: string; updated_at: string };
Insert: { id?: string; credential_id?: string; owner_id: string; issuer_id?: string | null; credential_type: CredentialType; category: CredentialCategory; title: string; description?: string | null; issue_date: string; expiry_date?: string | null; status?: CredentialStatus; issued_at?: string | null; revoked_at?: string | null; revocation_reason?: string | null; certificate_file_url?: string | null; verification_hash?: string; public_visible?: boolean; public_holder_name?: string | null; created_at?: string; updated_at?: string };
Update: { id?: string; credential_id?: string; owner_id?: string; issuer_id?: string | null; credential_type?: CredentialType; category?: CredentialCategory; title?: string; description?: string | null; issue_date?: string; expiry_date?: string | null; status?: CredentialStatus; issued_at?: string | null; revoked_at?: string | null; revocation_reason?: string | null; certificate_file_url?: string | null; verification_hash?: string; public_visible?: boolean; public_holder_name?: string | null; created_at?: string; updated_at?: string };
...
create_credential_draft: { Args: {actor_user:string;recipient_user:string;new_type:CredentialType;new_category:CredentialCategory;new_title:string;new_description:string|null;new_issue_date:string;new_expiry_date:string|null;new_badge?:string|null}; Returns: Json };
...
}; Enums: {credential_type: CredentialType; credential_status: CredentialStatus; badge_category: BadgeCategory; credential_category: CredentialCategory; issuer_role: IssuerRole}; CompositeTypes: Record<string, never>; } };
