...
export default function AboutPage() {
  return <div className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
    ...
    <div className="mt-12"><Button asChild variant="outline"><Link href="/verify">View verification availability <ArrowRight aria-hidden="true" /></Link></Button></div>
  </div>;
}
